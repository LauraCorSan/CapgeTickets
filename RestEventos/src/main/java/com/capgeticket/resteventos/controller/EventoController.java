...
public class EventoController {
	 ...
	 * 
	 * @param Recibe un id del objeto a editar y objeto de tipo Evento en formato
	 *               json
	 * @return Un evento dto
	 */

	@Operation(summary = "Modificar un evento existente", description = "Llama al servicio de evento para modificar un evento existente dado su ID.")
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Evento modificado correctamente."),
	 ...
	 * @return Un evento dto
	 */
	@Operation(summary = "Añadir un nuevo evento", description = "Crea un nuevo evento con la información proporcionada.")
	@ApiResponses(value = { @ApiResponse(responseCode = "201", description = "Evento creado correctamente."),
	 ...
	 *         eventos.
	 */
	@Operation(summary = "Listar todos los eventos", description = "Devuelve una lista de todos los eventos disponibles.")
	@ApiResponses(value = {
	...
	public List<EventoResponse> getEventoAll() {
		...
		if (eventos.isEmpty())
			throw new NoEventosException("Actualmento no existen datos en la base de datos");
	 ...
	 */
	@Operation(summary = "Detalles de un evento", description = "Devuelve los detalles del evento dado su ID.")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Detalles del evento devueltos correctamente."),
			@ApiResponse(responseCode = "404", description = "El evento con el ID proporcionado no fue encontrado.") })
	@GetMapping("/{id}")
	 ...
	 */
	@Operation(summary = "Buscar eventos por nombre", description = "Listado de eventos por su nombre")
	 ...
	 */
	@Operation(summary = "Eliminar un evento", description = "Elimina un evento específico dado su ID.")
