...
/**
 * Clase: EventoAdapter
 * Descripción: contiene métodos que convierten un objeto/s
 * Evento a EventoResponse 
 * Fecha: 21/10/24 
 * Versión: 1.0 
 * Autores: Elena Cantonero,
 * Laura Gregorio y Laura Cordero
 */
@Component
public class EventoAdapter {
	...
	/**
	 * Convierte un objeto EventoResponse(dto) en Evento (entity)
	 * @param eventoDto
	 * @return Evento
	 */

	public Evento toEntity(EventoResponse eventoDto) {
		return Evento.builder().id(eventoDto.getId())
